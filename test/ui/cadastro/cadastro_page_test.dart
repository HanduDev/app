...
void main() {
  ...
  testWidgets('Mostra todos os erros quando campos estão vazios', (tester) async {
    await buildForm(tester);
  ...
  testWidgets('Mostra erro de senhas diferentes mesmo com campos preenchidos', (tester) async {
    await buildForm(tester);
  ...
  testWidgets('Não mostra erros quando todos os campos estão corretos', (tester) async {
    await buildForm(tester);
